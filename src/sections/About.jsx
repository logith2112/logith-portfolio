      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            ...
            {/* Academic Panel Card */}
            <div className="noise-card p-6 sm:p-8 rounded-lg mt-4 border border-white/[0.03] bg-white/[0.01]">
              <div className="text-[9px] text-[#6b7280] tracking-widest uppercase mb-4">EDUCATION PROFILE</div>
              <div className="flex flex-col gap-4">
                <div>
                  <h4 className="text-sm sm:text-base font-display font-semibold text-white">
                    B.Tech Computer Science and Engineering
                  </h4>
                  <div className="text-xs text-cyber-lime mt-1 font-medium">
                ...
                <div className="flex items-center gap-12 mt-2 border-t border-white/[0.04] pt-4">
                  <div>
                    <div className="text-[8px] text-[#6b7280] tracking-widest">CGPA</div>
                    <div className="text-lg font-bold font-display text-white mt-0.5">7.15</div>
                  </div>
                  <div>
                    <div className="text-[8px] text-[#6b7280] tracking-widest">STATUS</div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {focuses.map((focus) => (
                <div
                  key={focus.title}
                  className="noise-card p-5 rounded-lg border border-white/[0.02] flex flex-col gap-3 justify-between"
                >
                  <div className="w-9 h-9 rounded-md bg-[#111215] flex items-center justify-center border border-white/5">
                    {focus.icon}
                  </div>
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 mt-1.5 leading-relaxed font-light">
                      {focus.desc}
                    </p>
                  </div>
                </div>
